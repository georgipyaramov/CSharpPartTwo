 ...
 * contained in another file test.txt. The result should be written in the file result.txt and the words should 
...
class WordsCount
{
    static void Main()
    {
        ...
        //Reads from the file and put the words to dictionary
